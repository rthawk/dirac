...
[_QWERTY] = {
  ...
  {MO_MOVE, KC_LALT, KC_LGUI, KC_LALT, KC_SPC,  KC_SPC,  MO_SYML, MO_NUML, KC_LEFT, KC_DOWN, KC_UP  , KC_RGUI}
},
...
[_MOVE] = {
  {KC_GRV,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE},
  {KC_TILD, XXXXXXX, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______},
  {_______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_END , KC_ENT,  KC_BSPC, _______, _______},
  {_______, _______, _______, _______, KC_BTN1, _______, _______, _______, _______, _______, _______, KC_RGUI}
},
